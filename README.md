...
A fresh FRAME-based [Substrate](https://www.substrate.io/) node with simple implementation of quadratic voting system :rocket:
- Take a look at pallet-quadratic-voting readme for more details.
